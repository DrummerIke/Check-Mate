...
Перед публикацией пройдите ручной smoke-test из [manual-test-checklist.md](./manual-test-checklist.md): он проверяет кликабельность стартовых кнопок, доски, меню и подсказок на mobile и desktop.
