...
Перед публикацией пройдите ручной smoke-test из [manual-test-checklist.md](./manual-test-checklist.md): он проверяет кликабельность стартовых кнопок, доски, меню и подсказок, а также координаты доски и подсветку хода соперника на mobile и desktop.
