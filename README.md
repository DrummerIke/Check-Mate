...
Перед публикацией пройдите ручной smoke-test из [manual-test-checklist.md](./manual-test-checklist.md): он проверяет кликабельность стартовых кнопок, доски, меню и подсказок, а также mobile-центрирование доски, desktop-координаты, строку последнего хода и подсветку хода соперника на mobile и desktop.
